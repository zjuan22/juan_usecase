...
#pktsize = [0 ,46, 174,430 ,942, 1198, 1436] # 46=124(128-4) - 78
pktsize = [0 ,30, 158,414,926,1120,1420] # 30=124(packetsize-4) - 94
...
print now.minute
create_dir="pcap_bng_up_ts_"+str(entries)+"_"+data_t 
...
for i in range(0, 7):
    ...
    pname = "./"+create_dir+"/nfpa.trPR_bng_ul_%d_%s.%dbytes.pcap" % (entries,data_t, pktsize[i]+94+4) #Update the name depending of the Use-Case, use the same format
